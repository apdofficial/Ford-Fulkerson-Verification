...
; ------------------------------------------------------------
; ---------- check_unknown ----------
(declare-const V@0@05 Int)
(declare-const i1@1@05 Int)
(declare-const visited@2@05 option<array>)
(declare-const s@3@05 Int)
(declare-const exc@4@05 $Ref)
(declare-const res@5@05 void)
(declare-const V@6@05 Int)
(declare-const i1@7@05 Int)
(declare-const visited@8@05 option<array>)
(declare-const s@9@05 Int)
(declare-const exc@10@05 $Ref)
(declare-const res@11@05 void)
(push) ; 1
...
;  :quant-instantiations    2
;  :rlimit-count            175824)
; [then-branch: 0 | 0 < V@6@05 | live]
; [else-branch: 0 | !(0 < V@6@05) | live]
(push) ; 3
; [then-branch: 0 | 0 < V@6@05]
(assert (< 0 V@6@05))
; [eval] visited != (None(): option[array])
; [eval] (None(): option[array])
(pop) ; 3
(push) ; 3
; [else-branch: 0 | !(0 < V@6@05)]
(assert (not (< 0 V@6@05)))
(pop) ; 3
(pop) ; 2
...
(assert (implies
  (< 0 V@6@05)
  (not (= visited@8@05 (as None<option<array>>  option<array>)))))
(assert (=
  ($Snap.second $t@12@05)
  ($Snap.combine
...
;  :quant-instantiations    2
;  :rlimit-count            176970)
; [then-branch: 1 | 0 < V@6@05 | live]
; [else-branch: 1 | !(0 < V@6@05) | live]
(push) ; 3
; [then-branch: 1 | 0 < V@6@05]
(assert (< 0 V@6@05))
...
(push) ; 5
(assert (not (not (= visited@8@05 (as None<option<array>>  option<array>)))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
...
;  :quant-instantiations    2
;  :rlimit-count            177078)
(assert (not (= visited@8@05 (as None<option<array>>  option<array>))))
(pop) ; 4
; Joined path conditions
(assert (not (= visited@8@05 (as None<option<array>>  option<array>))))
(pop) ; 3
(push) ; 3
; [else-branch: 1 | !(0 < V@6@05)]
(assert (not (< 0 V@6@05)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
(assert (implies
  ...
  (and
    ...
    (not (= visited@8@05 (as None<option<array>>  option<array>))))))
; Joined path conditions
(assert (implies (< 0 V@6@05) (= (alen<Int> (opt_get1 $Snap.unit visited@8@05)) V@6@05)))
(assert (=
  ($Snap.second ($Snap.second $t@12@05))
  ($Snap.combine
...
;  :quant-instantiations    7
;  :rlimit-count            178456)
; [then-branch: 2 | 0 < V@6@05 | live]
; [else-branch: 2 | !(0 < V@6@05) | live]
(push) ; 3
; [then-branch: 2 | 0 < V@6@05]
(assert (< 0 V@6@05))
; [eval] 0 <= s
(pop) ; 3
(push) ; 3
; [else-branch: 2 | !(0 < V@6@05)]
(assert (not (< 0 V@6@05)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (implies (< 0 V@6@05) (<= 0 s@9@05)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@12@05)))
  ($Snap.combine
...
;  :quant-instantiations    12
;  :rlimit-count            179723)
; [then-branch: 3 | 0 < V@6@05 | live]
; [else-branch: 3 | !(0 < V@6@05) | live]
(push) ; 3
; [then-branch: 3 | 0 < V@6@05]
(assert (< 0 V@6@05))
; [eval] s < V
(pop) ; 3
(push) ; 3
; [else-branch: 3 | !(0 < V@6@05)]
(assert (not (< 0 V@6@05)))
(pop) ; 3
(pop) ; 2
; Joined path conditions
; Joined path conditions
(assert (implies (< 0 V@6@05) (< s@9@05 V@6@05)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@05))))
  ($Snap.combine
...
; [eval] alen(a2)
(push) ; 3
(assert (not (< i1@7@05 (alen<Int> (opt_get1 $Snap.unit visited@8@05)))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
;  :quant-instantiations    17
;  :rlimit-count            180628)
(assert (< i1@7@05 (alen<Int> (opt_get1 $Snap.unit visited@8@05))))
(pop) ; 2
; Joined path conditions
(assert (< i1@7@05 (alen<Int> (opt_get1 $Snap.unit visited@8@05))))
(assert (not
  (=
    (aloc ($Snap.combine $Snap.unit $Snap.unit) (opt_get1 $Snap.unit visited@8@05) i1@7@05)
    $Ref.null)))
...
; [eval] exc == null
(push) ; 3
; [then-branch: 4 | exc@10@05 == Null | live]
; [else-branch: 4 | exc@10@05 != Null | live]
(push) ; 4
; [then-branch: 4 | exc@10@05 == Null]
; [eval] 0 < V
(pop) ; 4
(push) ; 4
; [else-branch: 4 | exc@10@05 != Null]
(assert (not (= exc@10@05 $Ref.null)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
...
(set-option :timeout 10)
(push) ; 4
(assert (not (not (and (< 0 V@6@05) (= exc@10@05 $Ref.null)))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
;  :rlimit-count            182214)
(push) ; 4
(assert (not (and (< 0 V@6@05) (= exc@10@05 $Ref.null))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
;  :quant-instantiations    22
;  :rlimit-count            182266)
; [then-branch: 5 | 0 < V@6@05 && exc@10@05 == Null | live]
; [else-branch: 5 | !(0 < V@6@05 && exc@10@05 == Null) | dead]
(push) ; 4
; [then-branch: 5 | 0 < V@6@05 && exc@10@05 == Null]
(assert (and (< 0 V@6@05) (= exc@10@05 $Ref.null)))
; [eval] visited != (None(): option[array])
; [eval] (None(): option[array])
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (implies
  (and (< 0 V@6@05) (= exc@10@05 $Ref.null))
  (not (= visited@8@05 (as None<option<array>>  option<array>)))))
(assert (=
  ($Snap.second ($Snap.second $t@13@05))
  ($Snap.combine
...
; [eval] exc == null
(push) ; 3
; [then-branch: 6 | exc@10@05 == Null | live]
; [else-branch: 6 | exc@10@05 != Null | live]
(push) ; 4
; [then-branch: 6 | exc@10@05 == Null]
(assert (= exc@10@05 $Ref.null))
; [eval] 0 < V
(pop) ; 4
(push) ; 4
; [else-branch: 6 | exc@10@05 != Null]
(assert (not (= exc@10@05 $Ref.null)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
...
;  :quant-instantiations    22
;  :rlimit-count            183015)
; [then-branch: 7 | 0 < V@6@05 && exc@10@05 == Null | live]
; [else-branch: 7 | !(0 < V@6@05 && exc@10@05 == Null) | dead]
(push) ; 4
; [then-branch: 7 | 0 < V@6@05 && exc@10@05 == Null]
(assert (and (< 0 V@6@05) (= exc@10@05 $Ref.null)))
; [eval] alen(opt_get1(visited)) == V
; [eval] alen(opt_get1(visited))
; [eval] opt_get1(visited)
...
(assert (implies
  (and (< 0 V@6@05) (= exc@10@05 $Ref.null))
  (= (alen<Int> (opt_get1 $Snap.unit visited@8@05)) V@6@05)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@13@05)))
  ($Snap.combine
...
; [eval] exc == null
(push) ; 3
; [then-branch: 8 | exc@10@05 == Null | live]
; [else-branch: 8 | exc@10@05 != Null | live]
(push) ; 4
; [then-branch: 8 | exc@10@05 == Null]
(assert (= exc@10@05 $Ref.null))
; [eval] 0 < V
(pop) ; 4
(push) ; 4
; [else-branch: 8 | exc@10@05 != Null]
(assert (not (= exc@10@05 $Ref.null)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
...
;  :quant-instantiations    22
;  :rlimit-count            183833)
; [then-branch: 9 | 0 < V@6@05 && exc@10@05 == Null | live]
; [else-branch: 9 | !(0 < V@6@05 && exc@10@05 == Null) | dead]
(push) ; 4
; [then-branch: 9 | 0 < V@6@05 && exc@10@05 == Null]
(assert (and (< 0 V@6@05) (= exc@10@05 $Ref.null)))
; [eval] 0 <= s
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (implies (and (< 0 V@6@05) (= exc@10@05 $Ref.null)) (<= 0 s@9@05)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@05))))
  ($Snap.combine
...
; [eval] exc == null
(push) ; 3
; [then-branch: 10 | exc@10@05 == Null | live]
; [else-branch: 10 | exc@10@05 != Null | live]
(push) ; 4
; [then-branch: 10 | exc@10@05 == Null]
(assert (= exc@10@05 $Ref.null))
; [eval] 0 < V
(pop) ; 4
(push) ; 4
; [else-branch: 10 | exc@10@05 != Null]
(assert (not (= exc@10@05 $Ref.null)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
...
;  :quant-instantiations    22
;  :rlimit-count            184615)
; [then-branch: 11 | 0 < V@6@05 && exc@10@05 == Null | live]
; [else-branch: 11 | !(0 < V@6@05 && exc@10@05 == Null) | dead]
(push) ; 4
; [then-branch: 11 | 0 < V@6@05 && exc@10@05 == Null]
(assert (and (< 0 V@6@05) (= exc@10@05 $Ref.null)))
; [eval] s < V
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (implies (and (< 0 V@6@05) (= exc@10@05 $Ref.null)) (< s@9@05 V@6@05)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@05)))))
  ($Snap.combine
...
(push) ; 3
(push) ; 4
(assert (not (not (= exc@10@05 $Ref.null))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
;  :quant-instantiations    22
;  :rlimit-count            185301)
; [then-branch: 12 | exc@10@05 == Null | live]
; [else-branch: 12 | exc@10@05 != Null | dead]
(push) ; 4
; [then-branch: 12 | exc@10@05 == Null]
(assert (= exc@10@05 $Ref.null))
; [eval] 0 <= i1
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (implies (= exc@10@05 $Ref.null) (<= 0 i1@7@05)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@05))))))
  ($Snap.combine
...
;  :quant-instantiations    22
;  :rlimit-count            185979)
; [then-branch: 13 | exc@10@05 == Null | live]
; [else-branch: 13 | exc@10@05 != Null | dead]
(push) ; 4
; [then-branch: 13 | exc@10@05 == Null]
(assert (= exc@10@05 $Ref.null))
; [eval] i1 < V
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (implies (= exc@10@05 $Ref.null) (< i1@7@05 V@6@05)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@05)))))))
  ($Snap.combine
...
;  :quant-instantiations    22
;  :rlimit-count            186657)
; [then-branch: 14 | exc@10@05 == Null | live]
; [else-branch: 14 | exc@10@05 != Null | dead]
(push) ; 3
; [then-branch: 14 | exc@10@05 == Null]
(assert (= exc@10@05 $Ref.null))
; [eval] aloc(opt_get1(visited), i1)
; [eval] opt_get1(visited)
(push) ; 4
...
;  :quant-instantiations    22
;  :rlimit-count            187256)
; [then-branch: 15 | exc@10@05 == Null | live]
; [else-branch: 15 | exc@10@05 != Null | dead]
(push) ; 5
; [then-branch: 15 | exc@10@05 == Null]
...
(assert (implies
  (= exc@10@05 $Ref.null)
  (=
    ($SortWrappers.$SnapToBool ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@05)))))))))
    false)))
(pop) ; 3
(pop) ; 2
(push) ; 2
; [exec]
; var return: void
(declare-const return@14@05 void)
; [exec]
; exc := null
; [exec]
...
;  :quant-instantiations    22
;  :rlimit-count            187833)
; [then-branch: 17 | 0 < V@6@05 | live]
; [else-branch: 17 | !(0 < V@6@05) | dead]
(push) ; 4
; [then-branch: 17 | 0 < V@6@05]
(assert (< 0 V@6@05))
; [eval] visited != (None(): option[array])
; [eval] (None(): option[array])
(pop) ; 4
...
;  :quant-instantiations    22
;  :rlimit-count            188367)
; [then-branch: 19 | 0 < V@6@05 | live]
; [else-branch: 19 | !(0 < V@6@05) | dead]
(push) ; 4
; [then-branch: 19 | 0 < V@6@05]
(assert (< 0 V@6@05))
; [eval] alen(opt_get1(visited)) == V
; [eval] alen(opt_get1(visited))
; [eval] opt_get1(visited)
...
;  :quant-instantiations    22
;  :rlimit-count            188946)
; [then-branch: 21 | 0 < V@6@05 | live]
; [else-branch: 21 | !(0 < V@6@05) | dead]
(push) ; 4
; [then-branch: 21 | 0 < V@6@05]
(assert (< 0 V@6@05))
; [eval] 0 <= s
(pop) ; 4
(pop) ; 3
...
;  :quant-instantiations    22
;  :rlimit-count            189480)
; [then-branch: 23 | 0 < V@6@05 | live]
; [else-branch: 23 | !(0 < V@6@05) | dead]
(push) ; 4
; [then-branch: 23 | 0 < V@6@05]
(assert (< 0 V@6@05))
; [eval] s < V
(pop) ; 4
(pop) ; 3
