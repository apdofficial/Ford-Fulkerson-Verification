...
(declare-const exc@2@07 $Ref)
(declare-const res@3@07 option<array>)
(declare-const tid@4@07 Int)
(declare-const dim0@5@07 Int)
(declare-const exc@6@07 $Ref)
(declare-const res@7@07 option<array>)
(push) ; 1
...
(assert (= $t@8@07 ($Snap.combine ($Snap.first $t@8@07) ($Snap.second $t@8@07))))
(assert (= ($Snap.first $t@8@07) $Snap.unit))
; [eval] exc == null
(assert (= exc@6@07 $Ref.null))
(assert (=
  ($Snap.second $t@8@07)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@8@07))
    ($Snap.second ($Snap.second $t@8@07)))))
(assert (= ($Snap.first ($Snap.second $t@8@07)) $Snap.unit))
; [eval] exc == null ==> res != (None(): option[array])
; [eval] exc == null
(push) ; 3
(set-option :timeout 10)
(push) ; 4
(assert (not (not (= exc@6@07 $Ref.null))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
;  :rlimit-count            175855)
; [then-branch: 0 | exc@6@07 == Null | live]
; [else-branch: 0 | exc@6@07 != Null | dead]
(push) ; 4
; [then-branch: 0 | exc@6@07 == Null]
...
(assert (implies
  (= exc@6@07 $Ref.null)
  (not (= res@7@07 (as None<option<array>>  option<array>)))))
(assert (=
  ($Snap.second ($Snap.second $t@8@07))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@8@07)))
    ($Snap.second ($Snap.second ($Snap.second $t@8@07))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@8@07))) $Snap.unit))
...
;  :quant-instantiations    2
;  :rlimit-count            176474)
; [then-branch: 1 | exc@6@07 == Null | live]
; [else-branch: 1 | exc@6@07 != Null | dead]
(push) ; 4
; [then-branch: 1 | exc@6@07 == Null]
...
(push) ; 6
(assert (not (not (= res@7@07 (as None<option<array>>  option<array>)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
;  :quant-instantiations    2
;  :rlimit-count            176495)
(assert (not (= res@7@07 (as None<option<array>>  option<array>))))
(pop) ; 5
; Joined path conditions
(assert (not (= res@7@07 (as None<option<array>>  option<array>))))
(pop) ; 4
...
(assert (implies
  (= exc@6@07 $Ref.null)
  (= (alen<Int> (opt_get1 $Snap.unit res@7@07)) dim0@5@07)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@8@07)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@07))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@8@07)))))))
; [eval] exc == null
(set-option :timeout 10)
(push) ; 3
(assert (not (not (= exc@6@07 $Ref.null))))
...
;  :rlimit-count            177205)
; [then-branch: 2 | exc@6@07 == Null | live]
; [else-branch: 2 | exc@6@07 != Null | dead]
(push) ; 3
; [then-branch: 2 | exc@6@07 == Null]
(declare-const i0@9@07 Int)
(push) ; 4
; [eval] 0 <= i0 && i0 < dim0
; [eval] 0 <= i0
(push) ; 5
; [then-branch: 3 | 0 <= i0@9@07 | live]
; [else-branch: 3 | !(0 <= i0@9@07) | live]
(push) ; 6
; [then-branch: 3 | 0 <= i0@9@07]
(assert (<= 0 i0@9@07))
; [eval] i0 < dim0
(pop) ; 6
(push) ; 6
; [else-branch: 3 | !(0 <= i0@9@07)]
(assert (not (<= 0 i0@9@07)))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (and (< i0@9@07 dim0@5@07) (<= 0 i0@9@07)))
...
; [eval] alen(a2)
(push) ; 6
(assert (not (< i0@9@07 (alen<Int> (opt_get1 $Snap.unit res@7@07)))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
;  :quant-instantiations    7
;  :rlimit-count            177446)
(assert (< i0@9@07 (alen<Int> (opt_get1 $Snap.unit res@7@07))))
(pop) ; 5
; Joined path conditions
(assert (< i0@9@07 (alen<Int> (opt_get1 $Snap.unit res@7@07))))
(declare-const sm@10@07 $FVF<Bool>)
...
; Joined path conditions
(pop) ; 4
(declare-fun inv@11@07 ($Ref) Int)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i0@9@07 Int)) (!
  (and
    (not (= res@7@07 (as None<option<array>>  option<array>)))
    (< i0@9@07 (alen<Int> (opt_get1 $Snap.unit res@7@07))))
  :pattern (($FVF.loc_bool ($FVF.lookup_bool ($SortWrappers.$SnapTo$FVF<Bool> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@07))))) (aloc ($Snap.combine
    $Snap.unit
    $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@9@07)) (aloc ($Snap.combine
    $Snap.unit
    $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@9@07)))
  :qid |bool-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i01@9@07 Int) (i02@9@07 Int)) (!
  (implies
    (and
      (and (< i01@9@07 dim0@5@07) (<= 0 i01@9@07))
      (and (< i02@9@07 dim0@5@07) (<= 0 i02@9@07))
      (=
        (aloc ($Snap.combine $Snap.unit $Snap.unit) (opt_get1 $Snap.unit res@7@07) i01@9@07)
        (aloc ($Snap.combine $Snap.unit $Snap.unit) (opt_get1 $Snap.unit res@7@07) i02@9@07)))
    (= i01@9@07 i02@9@07))
...
(assert (forall ((i0@9@07 Int)) (!
  (implies
    (and (< i0@9@07 dim0@5@07) (<= 0 i0@9@07))
    (=
      (inv@11@07 (aloc ($Snap.combine $Snap.unit $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@9@07))
      i0@9@07))
  :pattern (($FVF.loc_bool ($FVF.lookup_bool ($SortWrappers.$SnapTo$FVF<Bool> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@07))))) (aloc ($Snap.combine
    $Snap.unit
    $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@9@07)) (aloc ($Snap.combine
...
(assert (forall ((r $Ref)) (!
  (implies
    (and (< (inv@11@07 r) dim0@5@07) (<= 0 (inv@11@07 r)))
    (=
      (aloc ($Snap.combine $Snap.unit $Snap.unit) (opt_get1 $Snap.unit res@7@07) (inv@11@07 r))
      r))
  :pattern ((inv@11@07 r))
  :qid |bool-fctOfInv|)))
...
(assert (forall ((i0@9@07 Int)) (!
  (implies
    ...
    (not
      (=
        (aloc ($Snap.combine $Snap.unit $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@9@07)
        $Ref.null)))
  :pattern (($FVF.loc_bool ($FVF.lookup_bool ($SortWrappers.$SnapTo$FVF<Bool> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@07))))) (aloc ($Snap.combine
    $Snap.unit
    $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@9@07)) (aloc ($Snap.combine
...
(declare-const sm@12@07 $FVF<Bool>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (implies
    (and (< (inv@11@07 r) dim0@5@07) (<= 0 (inv@11@07 r)))
    (=
      ($FVF.lookup_bool (as sm@12@07  $FVF<Bool>) r)
      ($FVF.lookup_bool ($SortWrappers.$SnapTo$FVF<Bool> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@07))))) r)))
  :pattern (($FVF.lookup_bool (as sm@12@07  $FVF<Bool>) r))
  :pattern (($FVF.lookup_bool ($SortWrappers.$SnapTo$FVF<Bool> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@07))))) r))
  :qid |qp.fvfValDef1|)))
(assert (forall ((r $Ref)) (!
  ($FVF.loc_bool ($FVF.lookup_bool ($SortWrappers.$SnapTo$FVF<Bool> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@07))))) r) r)
  :pattern (($FVF.lookup_bool (as sm@12@07  $FVF<Bool>) r))
  :qid |qp.fvfResTrgDef2|)))
(assert (forall ((r $Ref)) (!
  (implies
    (and (< (inv@11@07 r) dim0@5@07) (<= 0 (inv@11@07 r)))
    ($FVF.loc_bool ($FVF.lookup_bool (as sm@12@07  $FVF<Bool>) r) r))
  :pattern ((inv@11@07 r))
  )))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@8@07))))
...
;  :quant-instantiations    16
;  :rlimit-count            181202)
; [then-branch: 4 | exc@6@07 == Null | live]
; [else-branch: 4 | exc@6@07 != Null | dead]
(push) ; 5
; [then-branch: 4 | exc@6@07 == Null]
; [eval] (forall i0: Int :: { aloc(opt_get1(res), i0).bool } 0 <= i0 && i0 < dim0 ==> aloc(opt_get1(res), i0).bool == false)
(declare-const i0@13@07 Int)
(push) ; 6
; [eval] 0 <= i0 && i0 < dim0 ==> aloc(opt_get1(res), i0).bool == false
; [eval] 0 <= i0 && i0 < dim0
; [eval] 0 <= i0
(push) ; 7
; [then-branch: 5 | 0 <= i0@13@07 | live]
; [else-branch: 5 | !(0 <= i0@13@07) | live]
(push) ; 8
; [then-branch: 5 | 0 <= i0@13@07]
(assert (<= 0 i0@13@07))
; [eval] i0 < dim0
(pop) ; 8
(push) ; 8
; [else-branch: 5 | !(0 <= i0@13@07)]
(assert (not (<= 0 i0@13@07)))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(push) ; 7
; [then-branch: 6 | i0@13@07 < dim0@5@07 && 0 <= i0@13@07 | live]
; [else-branch: 6 | !(i0@13@07 < dim0@5@07 && 0 <= i0@13@07) | live]
(push) ; 8
; [then-branch: 6 | i0@13@07 < dim0@5@07 && 0 <= i0@13@07]
(assert (and (< i0@13@07 dim0@5@07) (<= 0 i0@13@07)))
...
; [eval] alen(a2)
(push) ; 10
(assert (not (< i0@13@07 (alen<Int> (opt_get1 $Snap.unit res@7@07)))))
(check-sat)
; unsat
(pop) ; 10
; 0.00s
...
;  :quant-instantiations    16
;  :rlimit-count            181447)
(assert (< i0@13@07 (alen<Int> (opt_get1 $Snap.unit res@7@07))))
(pop) ; 9
; Joined path conditions
(assert (< i0@13@07 (alen<Int> (opt_get1 $Snap.unit res@7@07))))
(assert ($FVF.loc_bool ($FVF.lookup_bool (as sm@12@07  $FVF<Bool>) (aloc ($Snap.combine
  $Snap.unit
  $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@13@07)) (aloc ($Snap.combine
  $Snap.unit
  $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@13@07)))
(push) ; 9
(assert (not (and
  (<
    (inv@11@07 (aloc ($Snap.combine $Snap.unit $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@13@07))
    dim0@5@07)
  (<=
    0
    (inv@11@07 (aloc ($Snap.combine $Snap.unit $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@13@07))))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 6 | !(i0@13@07 < dim0@5@07 && 0 <= i0@13@07)]
(assert (not (and (< i0@13@07 dim0@5@07) (<= 0 i0@13@07))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
(assert (implies
  (and (< i0@13@07 dim0@5@07) (<= 0 i0@13@07))
  (and
    (< i0@13@07 dim0@5@07)
    (<= 0 i0@13@07)
    (not (= res@7@07 (as None<option<array>>  option<array>)))
    (< i0@13@07 (alen<Int> (opt_get1 $Snap.unit res@7@07)))
    ($FVF.loc_bool ($FVF.lookup_bool (as sm@12@07  $FVF<Bool>) (aloc ($Snap.combine
      $Snap.unit
      $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@13@07)) (aloc ($Snap.combine
      $Snap.unit
      $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@13@07)))))
  ...
  (implies
    ...
    (and
      ...
      ($FVF.loc_bool ($FVF.lookup_bool (as sm@12@07  $FVF<Bool>) (aloc ($Snap.combine
        ...
        $Snap.unit
        $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@13@07))))
  :pattern (($FVF.loc_bool ($FVF.lookup_bool (as sm@12@07  $FVF<Bool>) (aloc ($Snap.combine
    $Snap.unit
    $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@13@07)) (aloc ($Snap.combine
    $Snap.unit
    $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@13@07)))
...
(assert (implies
  ...
  (forall ((i0@13@07 Int)) (!
    (implies
      (and (< i0@13@07 dim0@5@07) (<= 0 i0@13@07))
      (=
        ($FVF.lookup_bool (as sm@12@07  $FVF<Bool>) (aloc ($Snap.combine
          $Snap.unit
          $Snap.unit) (opt_get1 $Snap.unit res@7@07) i0@13@07))
        false))
    :pattern (($FVF.loc_bool ($FVF.lookup_bool (as sm@12@07  $FVF<Bool>) (aloc ($Snap.combine
