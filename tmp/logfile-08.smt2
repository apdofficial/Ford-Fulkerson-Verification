...
(assert (= ($Snap.first $t@6@08) $Snap.unit))
; [eval] exc == null
...
(push) ; 4
(assert (not (not (= exc@4@08 $Ref.null))))
(check-sat)
; unknown
(pop) ; 4
; 0.00s
...
;  :num-checks              2
;  :rlimit-count            69141)
; [then-branch: 0 | exc@4@08 == Null | live]
; [else-branch: 0 | exc@4@08 != Null | dead]
(push) ; 4
; [then-branch: 0 | exc@4@08 == Null]
; [eval] res != null
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (implies (= exc@4@08 $Ref.null) (not (= res@5@08 $Ref.null))))
(assert (= ($Snap.second ($Snap.second $t@6@08)) $Snap.unit))
; [eval] exc == null ==> type(res) == 1
; [eval] exc == null
(push) ; 3
(push) ; 4
(assert (not (not (= exc@4@08 $Ref.null))))
...
;  :num-checks              3
;  :rlimit-count            69477)
; [then-branch: 1 | exc@4@08 == Null | live]
; [else-branch: 1 | exc@4@08 != Null | dead]
(push) ; 4
; [then-branch: 1 | exc@4@08 == Null]
; [eval] type(res) == 1
; [eval] type(res)
(push) ; 5
(pop) ; 5
...
(pop) ; 3
; Joined path conditions
(assert (implies (= exc@4@08 $Ref.null) (= (type $Snap.unit res@5@08) 1)))
(pop) ; 2
(push) ; 2
; [exec]
; var return: Ref
...
; [exec]
; var this: Ref
(declare-const this@8@08 $Ref)
; [exec]
; exc := null
; [exec]
; this := new()
(declare-const this@9@08 $Ref)
(assert (not (= this@9@08 $Ref.null)))
(assert (not (= this@9@08 return@7@08)))
(assert (not (= this@9@08 res@5@08)))
(assert (not (= this@9@08 this@8@08)))
; [exec]
; inhale type(this) == 1
...
(pop) ; 3
; Joined path conditions
(assert (= (type $Snap.unit this@9@08) 1))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
; [exec]
; fold acc(lock_inv_FordFulkerson(this), write)
(assert (lock_inv_FordFulkerson%trigger $Snap.unit this@9@08))
; [exec]
; exhale acc(lock_inv_FordFulkerson(this), write) && this != null
; [eval] this != null
; [exec]
; return := this
; [exec]
